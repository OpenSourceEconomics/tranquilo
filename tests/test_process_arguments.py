...
def test_roundup_to_next_multiple_of_batch_size():
    assert _ceil_to_multiple(1, 1) == 1
    assert _ceil_to_multiple(456, 456) == 456
    assert _ceil_to_multiple(123123, 1) == 123123
    assert _ceil_to_multiple(1, 123123) == 123123
    assert _ceil_to_multiple(4, 10) == 10
