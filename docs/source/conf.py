#!/usr/bin/env python3
#
# tranquilo documentation build configuration file, created by
...
extlinks = {
    ...
    "gh": ("https://github.com/OpenSourceEconomics/tranquilo/pulls/%s", "#"),
}
...
release = version("tranquilo").split("+")[0]
...
html_theme_options = {
    "github_url": "https://github.com/OpenSourceEconomics/tranquilo",
}
